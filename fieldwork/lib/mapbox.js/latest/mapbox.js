(function e(t, n, r) {
        ...
        (function (window, document, undefined) {
            ...
            L.Mixin.Events = {
                addEventListener: function (types, fn, context) {
                    ...
                    var events = this[eventsKey] = this[eventsKey] || {},
                        contextId = context && context !== this && L.stamp(context), i, len, event, type, indexKey,
                        indexLenKey, typeIndex;
                    ...
                    var events = this[eventsKey], contextId = context && context !== this && L.stamp(context), i, len,
                        type, listeners, j, indexKey, indexLenKey, typeIndex, removed;
                    types = L.Util.splitWords(types);
                    for (i = 0, len = types.length; i < len; i++) {
                        type = types[i];
                        indexKey = type + "_idx";
            ...
            (function () {
                var ie = "ActiveXObject" in window, ielt9 = ie && !document.addEventListener,
                    ua = navigator.userAgent.toLowerCase(), webkit = ua.indexOf("webkit") !== -1,
                    chrome = ua.indexOf("chrome") !== -1, phantomjs = ua.indexOf("phantom") !== -1,
                    android = ua.indexOf("android") !== -1, android23 = ua.search("android [23]") !== -1,
                    gecko = ua.indexOf("gecko") !== -1, mobile = typeof orientation !== undefined + "",
                    ...
                    doc = document.documentElement, ie3d = ie && "transition" in doc.style,
                    webkit3d = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !android23,
                    gecko3d = "MozPerspective" in doc.style, opera3d = "OTransition" in doc.style,
                ...
                get: function (id) {
                    ...
                    do {
                        ...
                        if (pos === "relative" && !el.offsetLeft) {
                            var width = L.DomUtil.getStyle(el, "width"), maxWidth = L.DomUtil.getStyle(el, "max-width"),
                    ...
                    var is3d = L.Browser.webkit3d, open = "translate" + (is3d ? "3d" : "") + "(",
                        close = (is3d ? ",0" : "") + ")";
            ...
            L.extend(L.LatLng, {DEG_TO_RAD: Math.PI / 180, RAD_TO_DEG: 180 / Math.PI, MAX_MARGIN: 1e-9});
            L.LatLng.prototype = {
                equals: function (obj) {
                    if (!obj) {
                        return false
                    ...
                    var R = 6378137, d2r = L.LatLng.DEG_TO_RAD, dLat = (other.lat - this.lat) * d2r,
                        dLon = (other.lng - this.lng) * d2r, lat1 = this.lat * d2r, lat2 = other.lat * d2r,
                        sin1 = Math.sin(dLat / 2), sin2 = Math.sin(dLon / 2);
            ...
            L.LatLngBounds.prototype = {
                extend: function (obj) {
                    ...
                    var sw = this._southWest, ne = this._northEast, sw2 = bounds.getSouthWest(),
                        ne2 = bounds.getNorthEast(), latIntersects = ne2.lat >= sw.lat && sw2.lat <= ne.lat,
            ...
            L.Projection.SphericalMercator = {
                MAX_LATITUDE: 85.0511287798, project: function (latlng) {
                    var d = L.LatLng.DEG_TO_RAD, max = this.MAX_LATITUDE,
                        lat = Math.max(Math.min(max, latlng.lat), -max), x = latlng.lng * d, y = lat * d;
                    y = Math.log(Math.tan(Math.PI / 4 + y / 2));
                    return new L.Point(x, y)
                }, unproject: function (point) {
                    var d = L.LatLng.RAD_TO_DEG, lng = point.x * d,
            ...
            L.Map = L.Class.extend({
                ...
                invalidateSize: function (options) {
                    ...
                    var newSize = this.getSize(), oldCenter = oldSize.divideBy(2).round(),
                        newCenter = newSize.divideBy(2).round(), offset = oldCenter.subtract(newCenter);
                ...
                getBoundsZoom: function (bounds, inside, padding) {
                    ...
                    var zoom = this.getMinZoom() - (inside ? 1 : 0), maxZoom = this.getMaxZoom(), size = this.getSize(),
                        nw = bounds.getNorthWest(), se = bounds.getSouthEast(), zoomNotFound = true, boundsSize;
            ...
            L.Projection.Mercator = {
                ...
                project: function (latlng) {
                    var d = L.LatLng.DEG_TO_RAD, max = this.MAX_LATITUDE,
                        lat = Math.max(Math.min(max, latlng.lat), -max), r = this.R_MAJOR, r2 = this.R_MINOR,
                        x = latlng.lng * d * r, y = lat * d, tmp = r2 / r, eccent = Math.sqrt(1 - tmp * tmp),
                ...
                unproject: function (point) {
                    var d = L.LatLng.RAD_TO_DEG, r = this.R_MAJOR, r2 = this.R_MINOR, lng = point.x * d / r,
                        tmp = r2 / r, eccent = Math.sqrt(1 - tmp * tmp), ts = Math.exp(-point.y / r),
                        phi = Math.PI / 2 - 2 * Math.atan(ts), numIter = 15, tol = 1e-7, i = numIter, dphi = .1, con;
            ...
            L.TileLayer = L.Class.extend({
                ...
                onRemove: function (map) {
                    ...
                    if (this._animated) {
                        map.off({zoomanim: this._animateZoom, zoomend: this._endZoomAnim}, this)
                    }
                    if (!this.options.updateWhenIdle) {
                ...
                _getTileSize: function () {
                    var map = this._map, zoom = map.getZoom() + this.options.zoomOffset,
                        zoomN = this.options.maxNativeZoom, tileSize = this.options.tileSize;
                    if (zoomN && zoom > zoomN) {
                ...
                _update: function () {
                    ...
                    var map = this._map, bounds = map.getPixelBounds(), zoom = map.getZoom(),
                ...
                _tileShouldBeLoaded: function (tilePoint) {
                    ...
                    if (options.bounds) {
                        var tileSize = this._getTileSize(), nwPoint = tilePoint.multiplyBy(tileSize),
                            sePoint = nwPoint.add([tileSize, tileSize]), nw = this._map.unproject(nwPoint),
            ...
            L.TileLayer.WMS = L.TileLayer.extend({
                defaultWmsParams: {
                    ...
                    var map = this._map, tileSize = this.options.tileSize, nwPoint = tilePoint.multiplyBy(tileSize),
            ...
            L.TileLayer.Canvas = L.TileLayer.extend({
                options: {async: false}, initialize: function (options) {
                    L.setOptions(this, options)
                }, redraw: function () {
                    if (this._map) {
                        this._reset({hard: true});
            ...
            L.ImageOverlay = L.Class.extend({
                includes: L.Mixin.Events, options: {opacity: 1}, initialize: function (url, bounds, options) {
                    this._url = url;
                    ...
                    var map = this._map, image = this._image, scale = map.getZoomScale(e.zoom),
                        nw = this._bounds.getNorthWest(), se = this._bounds.getSouthEast(),
                        topLeft = map._latLngToNewLayerPoint(nw, e.zoom, e.center),
                        size = map._latLngToNewLayerPoint(se, e.zoom, e.center)._subtract(topLeft),
                        origin = topLeft._add(size._multiplyBy(1 / 2 * (1 - 1 / scale)));
                    image.style[L.DomUtil.TRANSFORM] = L.DomUtil.getTranslateString(origin) + " scale(" + scale + ") "
                }, _reset: function () {
                    var image = this._image, topLeft = this._map.latLngToLayerPoint(this._bounds.getNorthWest()),
            ...
            L.Icon = L.Class.extend({
                options: {className: ""}, initialize: function (options) {
                    L.setOptions(this, options)
            ...
            L.Marker = L.Class.extend({
                ...
                _initIcon: function () {
                    var options = this.options, map = this._map,
            ...
            L.Popup = L.Class.extend({
                ...
                _initLayout: function () {
                    var prefix = "leaflet-popup",
                        ...
                        container = this._container = L.DomUtil.create("div", containerClass), closeButton;
                ...
                _updateLayout: function () {
                    ...
                    style.whiteSpace = "";
                    style.height = "";
                    var height = container.offsetHeight, maxHeight = this.options.maxHeight,
                ...
                _updatePosition: function () {
                    ...
                    var pos = this._map.latLngToLayerPoint(this._latlng), animated = this._animated,
                ...
                _adjustPan: function () {
                    ...
                    var containerPos = map.layerPointToContainerPoint(layerPos),
                        ...
                        paddingBR = L.point(this.options.autoPanPaddingBottomRight || padding), size = map.getSize(),
                        dx = 0, dy = 0;
            ...
            L.Map.include({
                _updatePathViewport: function () {
                    var p = L.Path.CLIP_PADDING, size = this.getSize(), panePos = L.DomUtil.getPosition(this._mapPane),
            ...
            L.Path = L.Path.extend({
                statics: {SVG: L.Browser.svg}, bringToFront: function () {
                    ...
                    var map = this._map, containerPoint = map.mouseEventToContainerPoint(e),
            ...
            L.Map.include({
                _initPathRoot: function () {
                    ...
                    var vp = this._pathViewport, min = vp.min, max = vp.max, width = max.x - min.x,
                        height = max.y - min.y, root = this._pathRoot, pane = this._panes.overlayPane;
            ...
            L.Path = L.Browser.svg || !L.Browser.vml ? L.Path : L.Path.extend({
                statics: {VML: true, CLIP_PADDING: .02}, _createElement: function () {
                    try {
            ...
            L.Path = L.Path.SVG && !window.L_PREFER_CANVAS || !L.Browser.canvas ? L.Path : L.Path.extend({
                statics: {CANVAS: true, SVG: false}, redraw: function () {
                    if (this._map) {
                        this.projectLatlngs();
                        this._requestUpdate()
                    }
            ...
            L.LineUtil = {
                simplify: function (points, tolerance) {
                    ...
                    var codeA = useLastCode ? this._lastCode : this._getBitCode(a, bounds),
                        codeB = this._getBitCode(b, bounds), codeOut, p, newCode;
            ...
            L.Polyline = L.Path.extend({
                ...
                }, options: {smoothFactor: 1, noClip: false}, projectLatlngs: function () {
            ...
            L.Polygon = L.Polyline.extend({
                options: {fill: true}, initialize: function (latlngs, options) {
            ...
            L.Circle = L.Path.extend({
                initialize: function (latlng, radius, options) {
                ...
                }, options: {fill: true}, setLatLng: function (latlng) {
                    this._latlng = L.latLng(latlng);
                    return this.redraw()
                    ...
                    var lngRadius = this._getLngRadius(), latlng = this._latlng,
                        pointLeft = this._map.latLngToLayerPoint([latlng.lat, latlng.lng - lngRadius]);
                    this._point = this._map.latLngToLayerPoint(latlng);
                    this._radius = Math.max(this._point.x - pointLeft.x, 1)
                }, getBounds: function () {
                    var lngRadius = this._getLngRadius(), latRadius = this._mRadius / 40075017 * 360,
                        latlng = this._latlng;
            ...
            L.CircleMarker = L.Circle.extend({
                options: {radius: 10, weight: 2}, initialize: function (latlng, options) {
            ...
            L.extend(L.GeoJSON, {
                geometryToLayer: function (geojson, pointToLayer, coordsToLatLng, vectorOptions) {
                    var geometry = geojson.type === "Feature" ? geojson.geometry : geojson,
                        coords = geometry.coordinates, layers = [], latlng, latlngs, i, len;
            ...
            L.Map.Drag = L.Handler.extend({
                addHooks: function () {
                    ...
                    var worldWidth = this._worldWidth, halfWidth = Math.round(worldWidth / 2),
                        dx = this._initialWorldOffset, x = this._draggable._newPos.x,
                        newX1 = (x - halfWidth + dx) % worldWidth + halfWidth - dx,
                        newX2 = (x + halfWidth + dx) % worldWidth - halfWidth - dx,
                        newX = Math.abs(newX1 + dx) < Math.abs(newX2 + dx) ? newX1 : newX2;
                    this._draggable._newPos.x = newX
                }, _onDragEnd: function (e) {
                    var map = this._map, options = map.options, delay = +new Date - this._lastTime,
                    ...
                    if (noInertia) {
                        ...
                        var direction = this._lastPos.subtract(this._positions[0]),
                            duration = (this._lastTime + delay - this._times[0]) / 1e3, ease = options.easeLinearity,
            ...
            L.extend(L.DomEvent, {
                ...
                addDoubleTapListener: function (obj, handler, id) {
                    var last, doubleTap = false, delay = 250, touch, pre = "_leaflet_", touchstart = this._touchstart,
            ...
            L.Map.TouchZoom = L.Handler.extend({
                addHooks: function () {
                    ...
                    var map = this._map, origin = this._getScaleOrigin(), center = map.layerPointToLatLng(origin),
                    ...
                    var origin = this._getScaleOrigin(), center = map.layerPointToLatLng(origin),
                        oldZoom = map.getZoom(), floatZoomDelta = map.getScaleZoom(this._scale) - oldZoom,
            ...
            L.Handler.MarkerDrag = L.Handler.extend({
                initialize: function (marker) {
                    ...
                    var marker = this._marker, shadow = marker._shadow, iconPos = L.DomUtil.getPosition(marker._icon),
            ...
            L.Control = L.Class.extend({
                options: {position: "topright"}, initialize: function (options) {
                    L.setOptions(this, options)
            ...
            L.Map.include({
                addControl: function (control) {
                    ...
                    var corners = this._controlCorners = {}, l = "leaflet-",
            ...
            L.Control.Scale = L.Control.extend({
                options: {position: "bottomleft", maxWidth: 100, metric: true, imperial: true, updateWhenIdle: false},
                onAdd: function (map) {
                    this._map = map;
                    var className = "leaflet-control-scale", container = L.DomUtil.create("div", className),
                        options = this.options;
                ...
                _update: function () {
                    var bounds = this._map.getBounds(), centerLat = bounds.getCenter().lat,
            ...
            L.PosAnimation = L.Class.extend({
                includes: L.Mixin.Events, run: function (el, newPos, duration, easeLinearity) {
                    this.stop();
                    this._el = el;
            ...
            L.TileLayer.include({
                _animateZoom: function (e) {
                    ...
                    var bg = this._bgBuffer, transform = L.DomUtil.TRANSFORM,
    ...
    6: [function (require, module, exports) {
        "use strict";
        var util = require("./util"), urlhelper = require("./url"), request = require("./request"),
            marker = require("./marker"), simplestyle = require("./simplestyle");
        var FeatureLayer = L.FeatureGroup.extend({
            options: {
                filter: function () {
                    return true
                }, sanitizer: require("sanitize-caja"), style: simplestyle.style, popupOptions: {closeButton: false}
                ...
                var features = L.Util.isArray(json) ? json : json.features, i, len;
                if (features) {
                    for (i = 0, len = features.length; i < len; i++) {
                    ...
                    var opts = {accessToken: this.options.accessToken},
                        ...
                        popupHtml = marker.createPopup(json, this.options.sanitizer), style = this.options.style,
                        defaultStyle = style === simplestyle.style;
                    if (style && "setStyle" in layer && !(defaultStyle && (layer instanceof L.Circle || layer instanceof L.CircleMarker))) {
                        if (typeof style === "function") {
                            style = style(json)
                        }
                        layer.setStyle(style)
    ...
    }, {"./marker": 20, "./request": 21, "./simplestyle": 23, "./url": 25, "./util": 26, "sanitize-caja": 29}],
    7: [function (require, module, exports) {
        "use strict";
        var Feedback = L.Class.extend({
            includes: L.Mixin.Events, data: {}, record: function (data) {
    ...
    8: [function (require, module, exports) {
        "use strict";
        var isArray = require("isarray"), util = require("./util"), urlhelper = require("./url"),
        ...
        module.exports = function (url, options) {
            ...
            geocoder.queryURL = function (_) {
                var isObject = !(isArray(_) || typeof _ === "string"), query = isObject ? _.query : _;
                if (isArray(query)) {
                    var parts = [];
                ...
                request(geocoder.queryURL(_), function (err, json) {
                    if (json && (json.length || json.features)) {
                        ...
                        if (json.features && json.features.length) {
                            res.latlng = [json.features[0].center[1], json.features[0].center[0]];
    ...
    }, {"./feedback": 7, "./request": 21, "./url": 25, "./util": 26, isarray: 2}],
    9: [function (require, module, exports) {
        "use strict";
        var geocoder = require("./geocoder"), util = require("./util");
        var GeocoderControl = L.Control.extend({
            includes: L.Mixin.Events,
            options: {proximity: true, position: "topleft", pointZoom: 16, keepOpen: false, autocomplete: false},
            initialize: function (_, options) {
            ...
            _chooseResult: function (result) {
                if (result.bbox) {
                    ...
                    this._map.setView([result.center[1], result.center[0]], this._map.getZoom() === undefined ? this.options.pointZoom : Math.max(this._map.getZoom(), this.options.pointZoom))
                }
            },
            _geocode: function (e) {
                L.DomEvent.preventDefault(e);
    ...
    10: [function (require, module, exports) {
        ...
        module.exports = function (data) {
            return function (x, y) {
                if (!data) return;
                var idx = utfDecode(data.grid[y].charCodeAt(x)), key = data.keys[idx];
    ...
    11: [function (require, module, exports) {
        "use strict";
        var util = require("./util"), Mustache = require("mustache");
        var GridControl = L.Control.extend({
            options: {
                ...
                touchTeaser: true,
                location: true
            }, _currentContent: "", _pinned: false, initialize: function (_, options) {
                L.Util.setOptions(this, options);
                ...
                if (template) {
                    var d = {};
                    d["__" + format + "__"] = true;
                    return this.options.sanitizer(Mustache.to_html(template, L.extend(d, data)))
                }
            }, _show: function (content, o) {
                if (content === this._currentContent) return;
                this._currentContent = content;
                if (this.options.follow) {
                    this._popup.setContent(content).setLatLng(o.latLng);
                ...
                if (this.options.location && location_formatted && location_formatted.search(/^https?:/) === 0) {
                ...
                link.href = "#";
                link.title = "close";
                L.DomEvent.on(link, "click", L.DomEvent.stopPropagation).on(link, "mousedown", L.DomEvent.stopPropagation).on(link, "dblclick", L.DomEvent.stopPropagation).on(link, "click", L.DomEvent.preventDefault).on(link, "click", fn, this);
                return link
            }, onAdd: function (map) {
                this._map = map;
                var className = "leaflet-control-grid map-tooltip", container = L.DomUtil.create("div", className),
                ...
                L.DomEvent.disableClickPropagation(container).addListener(container, "mousewheel", L.DomEvent.stopPropagation);
    ...
    }, {"./util": 26, mustache: 28, "sanitize-caja": 29}],
    12: [function (require, module, exports) {
        ...
        var GridLayer = L.Class.extend({
            includes: [L.Mixin.Events, require("./load_tilejson")], options: {
            ...
            }, _mouseOn: null, _tilejson: {}, _cache: {}, initialize: function (_, options) {
                L.Util.setOptions(this, options);
                ...
                var map = this._map, point = map.project(latlng.wrap()), tileSize = 256, resolution = 4,
                    x = Math.floor(point.x / tileSize), y = Math.floor(point.y / tileSize),
                ...
                this.getData(e.latlng, L.bind(function (data) {
                    if (data !== this._mouseOn) {
                        ...
                        this.fire("mouseover", {latLng: e.latlng, data: data});
                        this._mouseOn = data
                    } else {
                ...
                var urls = this.options.grids, index = (tilePoint.x + tilePoint.y) % urls.length, url = urls[index];
                return L.Util.template(url, tilePoint)
            }, _update: function () {
                if (!this.active()) return;
                var bounds = this._map.getPixelBounds(), z = this._map.getZoom(), tileSize = 256;
                ...
                var key = z + "_" + x + "_" + y, tilePoint = L.point(x, y);
                tilePoint.z = z;
                ...
                if (this.options.bounds) {
                    var tileSize = 256, nwPoint = tilePoint.multiplyBy(tileSize),
                        sePoint = nwPoint.add(new L.Point(tileSize, tileSize)), nw = this._map.unproject(nwPoint),
                        se = this._map.unproject(sePoint), bounds = new L.LatLngBounds([nw, se]);
    ...
    }, {"./grid": 10, "./load_tilejson": 16, "./request": 21, "./util": 26}],
    13: [function (require, module, exports) {
        "use strict";
        var InfoControl = L.Control.extend({
            options: {position: "bottomright", sanitizer: require("sanitize-caja")}, initialize: function (options) {
                L.setOptions(this, options);
                this._info = {};
                ...
                map.off("layeradd", this._onLayerAdd, this).off("layerremove", this._onLayerRemove, this)
    ...
    16: [function (require, module, exports) {
        "use strict";
        var request = require("./request"), url = require("./url"), util = require("./util");
        module.exports = {
        ...
        var LMap = L.Map.extend({
            ...
            initialize: function (element, _, options) {
                ...
                if (this.options.tileLayer) {
                    this.tileLayer = tileLayer(undefined, withAccessToken(this.options.tileLayer, this.options.accessToken));
                    this.addLayer(this.tileLayer)
                }
                if (this.options.featureLayer) {
                    this.featureLayer = featureLayer(undefined, withAccessToken(this.options.featureLayer, this.options.accessToken));
                    this.addLayer(this.featureLayer)
                }
                if (this.options.gridLayer) {
                    this.gridLayer = gridLayer(undefined, withAccessToken(this.options.gridLayer, this.options.accessToken));
                ...
                if (this.options.shareControl) {
                    this.shareControl = shareControl(undefined, withAccessToken(this.options.shareControl, this.options.accessToken));
            ...
            _updateMapFeedbackLink: function () {
                ...
                if (link.length && this._loaded) {
                    ...
                    var id = tilejson.id || "";
                    var hash = "#" + id + "/" + center.lng.toFixed(3) + "/" + center.lat.toFixed(3) + "/" + this.getZoom();
            ...
            _updateLayer: function (layer) {
                ...
                if (!(L.stamp(layer) in this._zoomBoundLayers) && (layer.options.maxZoom || layer.options.minZoom)) {
    ...
    18: [function (require, module, exports) {
        ...
        window.L.Icon.Default.imagePath = (document.location.protocol === "https:" || document.location.protocol === "http:" ? "" : "https:") + "//api.tiles.mapbox.com/mapbox.js/" + "v" + require("../package.json").version + "/images"
    }, {
        "../package.json": 4,
        "./config": 5,
        "./feature_layer": 6,
    ...
    19: [function (require, module, exports) {
        ...
        var MapboxLogoControl = L.Control.extend({
            options: {position: "bottomleft"}, initialize: function (options) {
                L.setOptions(this, options)
            }, onAdd: function () {
    ...
    20: [function (require, module, exports) {
        "use strict";
        var url = require("./url"), util = require("./util"), sanitize = require("sanitize-caja");

        function icon(fp, options) {
            fp = fp || {};
            var sizes = {small: [20, 50], medium: [30, 70], large: [35, 90]}, size = fp["marker-size"] || "medium",
    ...
    }, {"./url": 25, "./util": 26, "sanitize-caja": 29}],
        ...
        var ShareControl = L.Control.extend({
            ...
            _shareClick: function (e) {
                ...
                var tilejson = this._tilejson || this._map._tilejson || {},
                    ...
                    share = ("<h3>Share this map</h3>" + '<div class="mapbox-share-buttons"><a class="mapbox-button mapbox-button-icon mapbox-icon-facebook" target="_blank" href="{{facebook}}">Facebook</a>' + '<a class="mapbox-button mapbox-button-icon mapbox-icon-twitter" target="_blank" href="{{twitter}}">Twitter</a>' + '<a class="mapbox-button mapbox-button-icon mapbox-icon-pinterest" target="_blank" href="{{pinterest}}">Pinterest</a></div>').replace("{{twitter}}", twitter).replace("{{facebook}}", facebook).replace("{{pinterest}}", pinterest),
    ...
    23: [function (require, module, exports) {
        ...
        function fallback(a, b) {
            var c = {};
            for (var k in b) {
                if (a[k] === undefined) c[k] = b[k]; else c[k] = a[k]
            }
            return c
        }
    ...
    24: [function (require, module, exports) {
        ...
        var TileLayer = L.TileLayer.extend({
            ...
            getTileUrl: function (tilePoint) {
                var tiles = this.options.tiles, index = Math.floor(Math.abs(tilePoint.x + tilePoint.y) % tiles.length),
                    url = tiles[index];
    ...
    }, {"./load_tilejson": 16, "./util": 26, "sanitize-caja": 29}],
    25: [function (require, module, exports) {
        ...
        module.exports = function (path, accessToken) {
            ...
            if (!accessToken && config.REQUIRE_ACCESS_TOKEN) {
                throw new Error("An API access token is required to use Mapbox.js. " + "See https://www.mapbox.com/mapbox.js/api/v" + version + "/api-access-tokens/")
            }
            ...
            if (config.REQUIRE_ACCESS_TOKEN) {
                if (accessToken[0] === "s") {
                    throw new Error("Use a public access token (pk.*) with Mapbox.js, not a secret access token (sk.*). " + "See https://www.mapbox.com/mapbox.js/api/v" + version + "/api-access-tokens/")
                }
                url += accessToken
            }
            return url
    ...
    26: [function (require, module, exports) {
        ...
        module.exports = {
            idUrl: function (_, t) {
                if (_.indexOf("/") === -1) t.loadID(_); else t.loadURL(_)
            }, log: function (_) {
    ...
    30: [function (require, module, exports) {
        ...
        var html = function (html4) {
            ...
            var ENTITIES = {lt: "<", LT: "<", gt: ">", GT: ">", amp: "&", AMP: "&", quot: '"', apos: "'", nbsp: " "};
            ...
            function parse(htmlText, handler, param) {
                ...
                var state = {noMoreGT: false, noMoreEndComments: false};
            ...
            function makeHtmlSanitizer(tagPolicy) {
                ...
                return makeSaxParser({
                    ...
                    }, pcdata: emit, rcdata: emit, cdata: emit, endDoc: function (out) {
            ...
            function log(logger, tagName, attribName, oldValue, newValue) {
                if (!attribName) {
                    logger(tagName + " removed", {change: "removed", tagName: tagName})
                }
